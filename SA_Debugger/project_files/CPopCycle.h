...
public:
    ...
    static inline int32_t& m_nCurrentZoneType = *(int32_t*)0xC0BC6C;

    static inline int32_t& m_nCurrentTimeOfWeek = *(int32_t*)0xC0BC70;
    static inline int32_t& m_nCurrentTimeIndex = *(int32_t*)0xC0BC74;
    ...
    using PercDataArray = uint8_t[24 / PERC_DATA_TIME_RESOLUTION_HR][2][(uint32_t)(20)];
